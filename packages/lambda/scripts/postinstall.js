...
const TARBALL_FILENAME = 'chrome-headless-lambda-linux-62.0.3184.0.zip';
const TARBALL_URL = `https://raw.githubusercontent.com/neekolas/serverless-chrome/updated-chrome/packages/lambda/chrome/${TARBALL_FILENAME}`;
